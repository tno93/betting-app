...
export default function SignupPage() {
  ...
  if (success) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-zinc-50 to-white dark:from-zinc-950 dark:to-black p-4">
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            ...
            <CardDescription>Welcome to BetEdge. Redirecting to your dashboard...</CardDescription>
          </CardHeader>
        </Card>
      </div>
    );
      ...
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <span className="text-2xl font-bold">BetEdge</span>
          </div>
          <CardTitle>Create Your Account</CardTitle>
          <CardDescription>Start finding profitable betting opportunities today</CardDescription>
        </CardHeader>
        <CardContent>
